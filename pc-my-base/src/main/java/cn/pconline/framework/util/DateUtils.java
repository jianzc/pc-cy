...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils{
    ...
    public static String detailDateFormat = "yyyy-MM-dd HH:mm:ss";
     ...
     * @return String, 返回格式化的日期字符串
     */
    public static String dateStringDetail(Date def){
        if(def == null){
            return "";
        }
        return new SimpleDateFormat(detailDateFormat).format(def);
    }
	 ...
	 * @return
     */
	public static long differHours(Date endDate, Date startDate){
